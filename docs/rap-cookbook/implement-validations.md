...
- Die Message Class `ZXX_TRAVEL` um Nachrichten zur Validierung erweitern
- Die Nachrichtenklasse `ZXX_CM_TRAVEL` um Nachrichten zur Validierung erweitern
- Die Behavior Definition `ZXX_R_TRAVEL` um statische Feldkontrollen und Validierungen erweitern
- Die Verhaltensimplementierung `ZXX_BP_TRAVEL` um Behandlermethoden zur Validierung erweitern
